...
<html lang="{{ config('app.locale') }}">
    ...
    <body>
      ...
      <div  class="flex-center position-ref "style="border: solid;    border-width: 2px;background-color: #B03060">
       ...
       <h5 class="subtitulodeapp"> Quer também compartilhar sua história?<br/>
         Enviei e-mail para clubedaluta@gmail.com.
       </h5>

       <div id="artigo" class="row flex-center position-ref">
         <ul>
            @foreach ($history as $hisy)

             <li><a href="{{url('/textohistory',$hisy->id)}}" class="title-artigo" ><h3 class="title-artigo">{{ $hisy->title }}</a></li>
             <li><h5 style="text-color: grey" >{{substr($hisy->description, 0, 50)}}...</h5></li>
